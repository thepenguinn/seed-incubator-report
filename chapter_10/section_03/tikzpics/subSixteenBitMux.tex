...
\subtikzpicturedef{subSixteenBitMux} {
    ...
    %% TODO: EN is active low, so draw a bar above it.
    %% \overline is not pretty, \= is perfect but doesn't stretch more
    ...
    \draw [absCtkModule, thin]
    (#1-l11) ++(\absCtkPinPad, 0) node [right = 4pt] {\texttt{RW}}
    (#1-l11) coordinate (#1-rw)
    ;
