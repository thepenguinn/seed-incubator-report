\subtikzpicturedef{subAbsWaterPump} {
    origin%
} {
    ...
    \draw
    (#1-main-l0) ++(-2, 0) coordinate (#1-pa0)
    (#1-main-l1) ++(-2, 0) coordinate (#1-pa1)
    ;
    ...
    \ovrAbsPlainActuatorModuleDrawLabelName {#1-pa0} {PUMP 01}
    \ovrAbsPlainActuatorModuleDrawLabelName {#1-pa1} {PUMP 02}

    \ovrAbsMainDrawLabelName {#1-main} {RELAY}
...
\subtikzpictureactivate{subAbsWaterPump}
