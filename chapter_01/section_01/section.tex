...
system can be divided into two main sub-systems

\begin{itemize}
    \item \textbf{EMCU}: Environment Monitoring and Control Unit.
    \item \textbf{SINC}: Seed IncDroid (An Android Application).
\end{itemize}

%% PIC: An overview of the entire incubator
