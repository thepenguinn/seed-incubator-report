...
\section{Before We Begin} \label{sec:}
...
\alertNoteShow{Highlights information that the reader should take into account.}

\alertTipShow{Additional info and tips.}

\alertImportantShow{Provides crucial information.}

\alertWarningShow{Critical content that demands readers attention.}

\alertCautionShow{Critical content that could cause negative consequences.}


\subsection{Diagrams} \label{sec:}
...
\subsubsection{Abstract Diagrams}
...
\begin{center}
    ...
    \captionof{table}{Invalid and valid connections in diagrams throughout this document.}
