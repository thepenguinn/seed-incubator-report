...
\newcommand\alertImportantShow[1] {
    \begin{tcolorbox}[
...
\newcommand\alertImportant[1] {
    \begin{tcolorbox}[
            coltitle = colorAlertBgImportant,
            colbacktitle = colorAlertBgImportant,
            colback = colorAlertBgImportant,
            colframe = colorAlertBgImportant,
            title=Important,
