...
\alertImportant{
    If you have noticed, in \texttt{EMODE}, all the fans in the core block are
    inactive. Then how we are going to move air out of the incubator? That's
    where the exhaust branches and inlet comes into play. There are fans
    associated with the exhaust branches and inlets. Along with the core block,
    these systems help to move air in, out and around the incubator. See section
    \ref{sec:exhaustBranchesAndInlet} for more information.
}
